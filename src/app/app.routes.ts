...
import { BladeDetailComponent } from './components/blade-detail/blade-detail.component';
import { RubberDetailComponent } from './components/rubber-detail/rubber-detail.component';
...
export const routes: Routes = [
    ...
    { path: 'blades/:id', component: BladeDetailComponent },
    { path: 'rubbers', component: RubberListComponent },
    { path: 'rubbers/:id', component: RubberDetailComponent },
